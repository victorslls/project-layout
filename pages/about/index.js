...
const About = () => {
  ...
  return (
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left z-auto">
      <Circles />
      {/**avatar img */}
      <motion.div
      ...
      >
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Historias <span className="text-accent">cativantes</span> geram
            designs magníficos.
          </motion.h2>
          <motion.p
          ...
          >
            Há 2 anos comecei a trabalhar com freelancer como desenvolvedor.
            Desde então Faço trabalho remoto para agências, sou consultor para
            pequenas empresas, e tenho coloaboração em produtos de marketing
            digitais para uso comercial e de consumo.
          </motion.p>
          {/**couters */}
          <motion.div
