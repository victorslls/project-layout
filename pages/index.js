    ...
    <div className="bg-primary/60 h-full">
      ...
      to-black/10">
        <div className="text-center flex flex-col justify-center
         xl:pt-40 xl:text-left h-full container mx-auto">
          ...
          className="max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-10 xl:mb-16 color">
            todas as maneiras de indentificar um bom perfil para analise de projetos de software.
          </motion.p>
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
       ...
       {<ParticlesContainer />}
        ...
        className="w-full h-full max-w-[630px] max-h-[580px] absolute 
